...
export default function SimpleTestPage() {
	...
	useEffect(() => {
		// Debug: vérifier les classes HTML à chaque changement de thème
		...
		>
			<div style={{ maxWidth: "600px", margin: "0 auto" }}>
				...
				>
					...
					<p>
						Cette zone change de couleur selon le thème sélectionné.
					</p>
				...
				>
					<p>
						Si tu vois cette zone changer de couleur quand tu
						cliques sur les boutons, le thème fonctionne !
					</p>
				</div>
