      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            plan qui correspond à vos besoins.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-muted-foreground">
            <div className="text-center">
              <div className="bg-cyan-500/20 rounded-lg p-4 mb-4">
                ...
                <p className="text-sm">
                  Un paiement unique pour créer et mettre en ligne votre site
                </p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-cyan-500/20 rounded-lg p-4 mb-4">
                ...
                <p className="text-sm">
                  Garantit que votre site reste sécurisé, en ligne et à jour
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {creationPlans.map((plan, index) => (
              <div key={plan.name} className="relative group flex flex-col">
                {/* Carte principale */}
                <FeatureCard3D
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white/5 backdrop-blur-xl border border-neutral-500/30 rounded-2xl p-6">
              ...
              <p className="text-muted-foreground">
                Parce qu&apos;un site web a besoin d&apos;être hébergé, protégé
                et mis à jour en continu. L&apos;abonnement garantit que votre
                site reste sécurisé, performant et toujours accessible.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-neutral-500/30 rounded-2xl p-6">
              ...
              <p className="text-muted-foreground">
                Oui, à tout moment ! Vous pouvez passer d&apos;un plan à
                l&apos;autre selon l&apos;évolution de vos besoins.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-neutral-500/30 rounded-2xl p-6">
              ...
              <p className="text-muted-foreground">
                Votre site sera mis hors ligne. Nous vous recommandons de
                maintenir l&apos;abonnement pour garantir la continuité de votre
                présence en ligne.
              </p>
            </div>
          </div>
